...
def create_config(base_config_path="bert_trainer_config.yaml", **update_config):
    ...
    print(
        f"Combining values supplied as `keywords arguments` with base config from {base_config_path}" if update_config else f"Using base config from {base_config_path}")
